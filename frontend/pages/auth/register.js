...
export default function Register() {
  ...
  return (
    <>
      <Head><title>Create Account — ValuBull</title></Head>
      ...
      <div className="min-h-[calc(100vh-52px)] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">Start analysing stocks for free</p>
          </div>
              ...
              <div>
                ...
                {password.length > 0 && (
                  <div className="mt-1.5 flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-gray-500">{strengthLabel[strength]}</span>
                  </div>
                )}
              </div>
